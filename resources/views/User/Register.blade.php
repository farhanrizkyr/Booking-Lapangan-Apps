...
<head>
  ...
  <title>Apps User/ Login - NiceAdmin Bootstrap Template</title>
  ...
  <!-- Google Fonts -->
  <link href="{{asset('User')}}/https://fonts.gstatic.com" rel="preconnect">
  <link href="{{asset('User')}}/https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" class="row g-3 needs-validation" action="{{route('proses-register-user')}}">
                    @csrf
                    ...
                    <div class="col-12">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          <span class="input-group-text" id="inputGroupPrepend"><i class="bi bi-file-lock2-fill"></i></span>
                          <input type="password" name="password_confirmation" class="form-control" id="yourUsername">
                        </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">have account? <a href="/apps-user/auth">Login</a></p>
                    </div>
                  </form>
