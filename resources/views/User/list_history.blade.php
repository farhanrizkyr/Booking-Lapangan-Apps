...
@section('title','List History  Booking Lapangan')
@section('main')
    
<div class="pagetitle">
  <h1>Halaman List History Booking Lapangan</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/apps-user/dashboard">Dashboard</a></li>
      <li class="breadcrumb-item">Halaman History  Booking Lapangan</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="bi bi-x-octagon-fill"></i> Close</button>
           <form action="/apps-user/delete-history/{{$data->id}}" method="post">
            @csrf
            @method('delete')
